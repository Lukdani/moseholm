...
<body>
    ...
    <div class="hero overlay">
        <div class="overlay-text">
            ...
            <p class="mb-2">Moseholm er en 100% økologisk gårdbutik med tilhørende økologisk café
                <br>
                Besøg 
    ...
    <div class="section">
        ...
        <h1 class="section-header">Besøs os fordi:</h1>
        <div class="container-lg">      
        <div class="row">
            <div class="col-lg-4 hideOnSmall">
                <img src="./images/field.png"/>
            </div>
            <div class="col-12 col-lg-8 features-points-container">
        <table>
                    <tbody>
                        <tr>
        ...
        <div class="row">
            <div class="col-12 col-lg-4">
                ...
                <p class="events-item-date">12/12/2021</p>
                <h3 class="events-item-title">Bag dit eget brød fra bunden</h3>
                <p>Mal dit eget mel, hent vand i brønden, ælt din dej og bag det i vores stenovn</p>
            <button class="btn-secondary mt-2">Tilmeld dig nu</button>
            </div>
</div>
            <div class="col-12 col-lg-4">
                <div class="events-item">
                <p class="events-item-date">18/12/2021</p>
                <h3 class="events-item-title">Jul på Moseholm</h3>
            ...
            <div class="col-12 col-lg-4">
                <div class="events-item">
                <p class="events-item-date">20/12/2021</p>
                <h3 class="events-item-title">Bag dit eget brød fra bunden</h3>
                <p>Mal dit eget mel, hent vand i brønden, ælt din dej og bag det i vores stenovn</p>
                <button class="btn-secondary mt-2">Tilmeld dig nu</button>
            </div>
